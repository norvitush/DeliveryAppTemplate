...
public class CommonLowerPanel : LowerPanelView
{
    [Header("UI links")]
    ...
    private bool _isCartWithCounter = true;
    ...
    {
        if(needInvokeReaction) Publish(_selected);
    ...
    public override void SetActive(bool value) => gameObject.SetActive(true);
}
